...
6. 发版您的版本
    ...
    git tag  -a v1.8.3 -m "[已有 Mirror酱 CDK？点击前往高速下载](https://mirrorchyan.com/zh/projects?rid=Maa_MHXY_MG)"
    ...
    git -c http.sslVerify=false push origin v2.11.5
    # 删除配置项
    ...
    # 手动配置git的代理
    git config --global http.proxy http://127.0.0.2:1080
    git config --global https.proxy http://127.0.0.2:1080
    # 取消代理
...
feat:新增全局默认参数
feat:新增周长召唤灵乐园（内测）
feat:新增门派闯关、召唤灵海底、迷魂塔等任务兼容手动接取。

perf:修复优化副本任务
perf:修复家园整理卧室休息失败问题
perf:修复宠物祈福-文字识昴日星官-文字识别错误问题
perf:兼容秘境跳转、运镖活动识别，老电脑反应慢问题
perf:更新三界奇缘题库26.3.23，修改三界奇缘log输出
perf:兼容ui设计，优化科举乡试输入api框
perf:优化优化

chore:1.回退maafw版本5.8.1。2.升级阿瓦隆版本MFAA_VERSION: "v2.11.8"。3.升级棉絮MXU_VERSION: "v1.21.2".
chore:回退maafw版本5.8.1
